...
<body>
   ...
   {{-- <!-- Header -->
   <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"  bgcolor="#f8f8f8">
   <tr>
       <td height="20"></td>
   </tr>
   <tr>
       <td>
           <table with="100%" bgcolor="#cecece" border="0" cellpadding="0" cellspacing="0" align="center" 
