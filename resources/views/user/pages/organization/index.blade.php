<x-user.layout>
    ...
    @endif
    <div class="row mb-5">
        <form action="{{ route('user.update_organization', $administrator->id) }}" method="POST">
            @method('PUT')
            @csrf
            ...
            <div class="col-lg-12">
                ...
                <div class="mb-4">
                    ...
                    <select name="director" class="form-control {{ $errors->has('director') ? 'is-invalid' : '' }}"
                        id="director">
                ...
                <div class="mb-4">
                    ...
                    <select name="vice_director"
                        class="form-control {{ $errors->has('vice_director') ? 'is-invalid' : '' }}" id="vice_director">
                        <option value="">Pilih Pengurus</option>
                ...
                <div class="mb-4">
                    ...
                    <select name="secretary" class="form-control {{ $errors->has('secretary') ? 'is-invalid' : '' }}"
                        id="secretary">
                        <option value="">Pilih Pengurus</option>
                ...
                <div class="mb-4">
                    ...
                    <select name="treasurer" class="form-control {{ $errors->has('treasurer') ? 'is-invalid' : '' }}"
                        id="treasurer">
                        <option value="">Pilih Pengurus</option>
