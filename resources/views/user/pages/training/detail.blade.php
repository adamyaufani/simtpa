    ...
    <div class="row mb-5">
        ...
        <div class="col-lg-4">
            ...
            <div class="mb-3">
                ...
                <p class="text-secondary">{{ $training->start_date->isoFormat('D MMMM Y') }}
                    {{ $training->start_date->isoFormat('HH:MM') }}</p>
                <span>Tanggal Selesai</span>
                <p class="text-secondary">{{ $training->end_date->isoFormat('D MMMM Y') }}
                    {{ $training->end_date->isoFormat('HH:MM') }}</p>
                ...
                <div class="card-body">
                    ...
                    @if ($leftoverQuota > 0)
                        ...
                        <div class="d-flex align-items-center">
                            <div>
                                <input name="training_id" type="hidden" value="{{ $training->id }}" id="training_id">
                                <input name="qty" type="number"
                                    class="form-control {{ $errors->has('qty') ? 'is-invalid' : '' }}" id="qty"
                                    min="1" max="{{ $leftoverQuota }}" value='1'>
                    ...
                    @else
                        <p class="alert alert-warning"><i class="bi bi-exclamation-triangle"></i> Anda sudah terdaftar.
                        </p>
                    @endif
