<x-layout>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.update_student',$student->id) }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('school') is-invalid @enderror" id="school"
                        name="school" value="{{ old('school') ?? $student->school }}">
                    @error('school')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('ability_level_upon_entry') is-invalid @enderror"
                ...
                <div class="mb-3">
                    ...
                    @if($student->birth_certificate)
                        <img class="mt-3"
                            src="{{ route('admin.images').'?q='.$student->birth_certificate }}"
                            alt="">
                    @endif
                </div>
