<x-layout>
    ...
    <x-slot:title>
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Update Baru</h1>
        </div>
    </x-slot:title>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.update_letter',$letter->id) }}" method="POST"
                ...
                <div class="form-group">
                    ...
                    <textarea name="attachment" id="attachment" cols="10" rows="10"
                        class="form-control {{ $errors->has('attachment') ? 'is-invalid' : '' }}">{{ $letter->attachment }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" id="content" cols="10" rows="10"
                        class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }}">{{ $letter->content }}</textarea>
